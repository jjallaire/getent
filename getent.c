...
// defines we need to build outside of glibc trunk
#define RELEASE "development"
#define VERSION "2.22.90"
#define PKGVERSION VERSION
#define AI_IDN        0x0040  
#define AI_CANONIDN   0x0080
#define REPORT_BUGS_TO "jj@rstudio.com"
#define PACKAGE "getent"
...
static const char args_doc[] = "database [key ...]";

/* Supported options. */
static const struct argp_option args_options[] =
  {
    { "service", 's', "CONFIG", 0, "Service configuration to be used" },
    { "no-idn", 'i', NULL, 0, "disable IDN encoding" },
    { NULL, 0, NULL, 0, NULL },
  };

/* Short description of program.  */
static const char doc[] = "Get entries from administrative database.";
...
more_help (int key, const char *text, void *input)
{
  switch (key)
    ...
    case ARGP_KEY_HELP_EXTRA:
      ...
      if (fp != NULL)
	{
	  fputs_unlocked ("Supported databases:\n", fp);
  ...
  if ((argc - remaining) < 1)
    {
      ...
      argp_help (&argp, stdout, ARGP_HELP_SEE, "getent");
      return 1;
    }
